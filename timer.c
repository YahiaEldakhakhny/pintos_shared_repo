...
// This caused busy waiting.
 ...
 /**
  * Instead of yielding and busy waiting, a thread blocks on a semaphore. 
  * We calculate pre-determined time, when current thread should awake 
  * and store it in the variable tick, semaphore and thread itself in a structure sleep_list_elem. 
  * The structure is inserted into sleep_list in an increasing way by tick variable.
  */
